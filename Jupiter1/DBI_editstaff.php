...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE staff SET staff_id='$staff_id',store_id='$store_id',address_id='$address_id', first_name='$first_name', last_name='$last_name', picture='$picture', email='$email',active='$active',username='$username', password='$password', last_update ='$last_update' WHERE staff_id = '$id' ";   // update query
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" value="<?php echo $data['first_name'] ?>" name="first_name" placeholder="Your First Name..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" value="<?php echo $data['last_name'] ?>" name="last_name" placeholder="Your Last Name..." Required>
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="number" value="<?php echo $data['address_id'] ?>" name="address_id" placeholder="Your Address ID..." Required>
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="text" value="<?php echo $data['picture'] ?>" name="picture" placeholder="Your Picture.." Required>
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="text" value="<?php echo $data['email'] ?>" name="email" placeholder="Your Email..." Required> 
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="number" value="<?php echo $data['store_id'] ?>" name="store_id" placeholder="Your Store ID..." Required>
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="number" value="<?php echo $data['active'] ?>" name="active" placeholder="Your Active...." Required>
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="text" value="<?php echo $data['username'] ?>" name="username" placeholder="Your Username..." Required>
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="text" value="<?php echo $data['password'] ?>" name="password" placeholder="Your Password..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
