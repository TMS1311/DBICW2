...
$mysqlinput = "SELECT * FROM film_actor WHERE film_id='$id' AND actor_id='$id2'";
...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE film_actor SET  film_id='$film_id', actor_id='$actor_id', last_update ='$last_update' WHERE film_id='$id' AND actor_id = '$id2' ";   // update query
