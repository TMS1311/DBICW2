...
<h2>Insert Form For Film Rental</h2>
</p>\

<div class="container">
  <form action="DBI_insert_film_rental.php" method="post">
  <div class="row">
        <div class="col-25">
   ...
   <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="rentalduration" name="rental_duration" placeholder="1-100...">
      </select>
    </div>
        <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="rentalrate" name="rental_rate" placeholder="Your Rental Rate...">
      </select>
    </div>
   </div>
   <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="replacementcost" name="replacement_cost" placeholder="Your Replacement Cost...">
      </select>
    </div>
  <div class="row">
    <div class="col-25">
...
$rental_duration = mysqli_real_escape_string($conn, $_REQUEST['rental_duration']);
$rental_rate = mysqli_real_escape_string($conn, $_REQUEST['rental_rate']);
$replacement_cost = mysqli_real_escape_string($conn, $_REQUEST['replacement_cost']);
$last_update = mysqli_real_escape_string($conn, $_REQUEST['last_update']);
 

$mysqlinput = "INSERT INTO film_rental VALUES ('$film_id','$rental_duration','$rental_rate','$replacement_cost','$last_update')";
