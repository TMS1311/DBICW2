...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for Payment
      </p>

<div class="container">
<form action="DBI_insert_payment.php" method="post">
   <div class="row">
    <div class="col-25">
      <label for="paymentid">Payment ID:</label>
    </div>
    <div class="col-75">
      <input type="number" id="paymentid" name="payment_id" placeholder="Your Payment Id...">
      </select>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="amount" name="amount" placeholder="Your Amount...">
    </div>
  </div>
  <div class="row">
    <div class="row">
    ...
    <div class="col-75">
      <input type="datetime" id="paymentdate" name="payment_date" placeholder="Your Payment Date...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
...
$mysqlinput = "INSERT INTO payment VALUES ('$payment_id','$customer_id','$staff_id','$rental_id','$amount','&payment_date','$last_update')";
