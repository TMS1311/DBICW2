...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE customer SET customer_id='$customer_id',store_id='$store_id',address_id='$address_id', first_name='$first_name', last_name='$last_name',email='$email',active='$active',create_date='$create_date', last_update ='$last_update' WHERE customer_id = '$id' ";   // update query
...
<form method="POST">
  <form action="/action_page.php">
   <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="customerid" value="<?php echo $data['customer_id']?>" name="customer_id" placeholder="Your country ID..." Required>
      </select>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="storeid" value="<?php echo $data['store_id']?>" name="store_id" placeholder="Your store ID..." Required>
    </div>
  </div>
   <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="firstname" value="<?php echo $data['first_name']?>" name="first_name" placeholder="Your first name..." Required>
    </div>
  </div> 
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="lastname" value="<?php echo $data['last_name']?>" name="last_name" placeholder="Your last name..." Required>
    </div>
  </div> 
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="email" value="<?php echo $data['email']?>" name="email" placeholder="Your email..." Required>
    </div>
  </div>
    <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="addressid" value="<?php echo $data['address_id']?>" name="address_id" placeholder="Your address ID..." Required>
    </div>
  </div> 
    <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="active" value="<?php echo $data['active']?>" name="active" placeholder="Your active..." Required>
    </div>
  </div> 
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="datetime" id="createdate" value="<?php echo $data['create_date']?>" name="create_date" placeholder="YYYY/MM/DD HH:MM:SS" Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
