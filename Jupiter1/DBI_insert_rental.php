...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for Rental
      </p>

<div class="container">
<form action="DBI_insert_rental.php" method="post">
   <div class="row">
    <div class="col-25">
      <label for="rentalid">Rental ID:</label>
    </div>
    <div class="col-75">
      <input type="number" id="rentalid" name="rental_id" placeholder="Your Rental ID...">
      </select>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-75">
      <input type="datetime" id="rentaldate" name="rental_date" placeholder="Your Rental Date...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="inventoryid" name="inventory_id" placeholder="Your Inventory ID...">
    </div>
  </div>
  <div class="row">
      <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="customerid" name="customer_id" placeholder="Your customer ID...">
    </div>
  </div>
  <div class="row">
      <div class="col-25">
    ...
    <div class="col-75">
      <input type="datetime" id="returndate" name="return_date" placeholder="Your Return Date...">
    </div>
  </div>
  <div class="row">
      <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="staffid" name="staff_id" placeholder="Your Staff ID...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
...
$rental_id = mysqli_real_escape_string($conn, $_REQUEST['rental_id']);
$rental_date = mysqli_real_escape_string($conn, $_REQUEST['rental_date']);
$inventory_id = mysqli_real_escape_string($conn, $_REQUEST['inventory_id']);
...
$mysqlinput = "INSERT INTO rental VALUES ('$rental_id','$rental_date','$inventory_id','$customer_id','$return_date','$staff_id','$last_update')";
