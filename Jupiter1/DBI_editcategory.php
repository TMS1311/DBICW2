...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE category SET category_id='$category_id', name='$name', last_update ='$last_update' WHERE category_id = '$id' ";   // update query
...
<div class="container">
 <form method="POST">
   <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="categoryid" value="<?php echo $data['category_id']?>" name="category_id" placeholder="Your category ID..." Required>
      </select>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="name" value="<?php echo $data['name']?>" name="name" placeholder="Your name..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
