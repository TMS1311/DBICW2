...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE actor SET actor_id='$actor_id', first_name='$first_name', last_name='$last_name', last_update ='$last_update' WHERE actor_id = '$id' ";   // update query
...
<div class="container">
 <form method="POST">
   <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="actorid" value="<?php echo $data['actor_id']?>" name="actor_id" placeholder="Your actor ID..." Required>
      </select>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="firstname" value="<?php echo $data['first_name']?>" name="first_name" placeholder="Your name.." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
