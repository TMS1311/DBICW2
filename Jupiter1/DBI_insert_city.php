 ...
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="DBI_update.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Update</a>
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
      ...
      <a href="DBI_insert_city.php" class="w3-bar-item w3-button">Auto Insert</a>
    </div>
  </div>
...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for City
      </p>

<div class="container">
<form action="DBI_insert_city.php" method="post">
   <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="countryid" name="country_id" placeholder="Your country ID...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
...
$mysqlinput = "INSERT INTO city VALUES ('$city_id','$city','$country_id','$last_update')";
