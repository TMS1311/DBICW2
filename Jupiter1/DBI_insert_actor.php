...
<h2>Insert Form For Actor</h2>
</p>

<div class="container">
<form action="DBI_insert_actor.php" method="post">
   <div class="row">
    <div class="col-25">
      <label for="actorid">Actor ID:</label>
    </div>
    <div class="col-75">
      <input type="number" id="actorid" name="actor_id" placeholder="Your actor ID...">
      </select>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="firstname" name="first_name" placeholder="Your name..">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
...
$actor_id = mysqli_real_escape_string($conn, $_REQUEST['actor_id']);
$first_name = mysqli_real_escape_string($conn, $_REQUEST['first_name']);
$last_name = mysqli_real_escape_string($conn, $_REQUEST['last_name']);
$last_update = mysqli_real_escape_string($conn, $_REQUEST['last_update']);
 

$mysqlinput = "INSERT INTO actor VALUES ('$actor_id','$first_name','$last_name','$last_update')";
