...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE city SET city_id='$city_id', country_id='$country_id', city='$city', last_update ='$last_update' WHERE city_id = '$id' ";   // update query
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="city" value="<?php echo $data['city']?>" name="city" placeholder="Your city..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="countryid" value="<?php echo $data['country_id']?>" name="country_id" placeholder="Your country ID..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="datetime" id="lastupdate" name="last_update" value="<?php echo $data['last_update']?>" placeholder="YYYY/MM/DD HH:MM:SS" Required>
    </div>
  </div>
  <div class="row">
