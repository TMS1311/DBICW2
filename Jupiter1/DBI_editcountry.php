...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE country SET  country_id='$country_id', country='$country', last_update ='$last_update' WHERE country_id = '$id' ";   // update query
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="country" value="<?php echo $data['country']?>" name="country" placeholder="Your country..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
