 ...
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="DBI_update.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Update</a>
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
      ...
      <a href="DBI_insert_film.php" class="w3-bar-item w3-button">Auto Insert</a>
    </div>
  </div>
...
$mysqlinput = "SELECT film_id, title, description, release_year, language_id, length, rating, special_features, last_update FROM film";
