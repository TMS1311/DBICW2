...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for Address
      </p>

<div class="container">
<form action="DBI_insert_address.php" method="post">
   <div class="row">
    <div class="col-25">
      <label for="addressid">address_id:</label>
    </div>
    <div class="col-75">
      <input type="number" id="address_id" name="address_id" placeholder="1-100...">
      </select>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
   ...
   <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="cityid" name="city_id" placeholder="Your city ID...">
    </div>
  </div>
   <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="postalcode" name="postal_code" placeholder="Your postal code...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
...
$city_id = mysqli_real_escape_string($conn, $_REQUEST['city_id']);
...
$mysqlinput = "INSERT INTO address VALUES ('$address_id','$address','$district','$city_id','$postal_code','&phone','$last_update')";
