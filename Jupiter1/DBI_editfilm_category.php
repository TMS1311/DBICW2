...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE film_category SET film_id='$film_id', category_id='$category_id', last_update ='$last_update' WHERE film_id = '$id' ";   // update query
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="number" value="<?php echo $data['category_id'] ?>" name="category_id" placeholder="Your Category ID..." Required>
      </select>
    </div>
   </div>
  <div class="row">
