...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for Staff
      </p>

<div class="container">
<form action="DBI_insert_staff.php" method="post">
   <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="picture" name="picture" placeholder="Your Picture..">
    </div>
  </div>
  <div class="row">
    <div class="row">
...
$mysqlinput = "INSERT INTO staff VALUES ('$staff_id','$first_name','$last_name','$address_id','$picture','$email','$store_id','$active','$username','$password','$last_update')";
