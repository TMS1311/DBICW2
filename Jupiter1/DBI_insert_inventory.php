...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for Inventory
      </p>
<div class="container">
<form action="DBI_insert_inventory.php" method="post">
   <div class="row">
        <div class="col-25">
...
$mysqlinput = "INSERT INTO inventory VALUES ('$inventory_id','$film_id','$store_id','$last_update')";
