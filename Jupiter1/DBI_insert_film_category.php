...
<p style = "font-family:Impact;font-size:30px;">
         Insert Form for Film Category
      </p>
        <div class="container">
<form action="DBI_insert_film_category.php" method="post">
  <div class="row">
        <div class="col-25">
    ...
    <div class="col-75">
      <input type="number" id="categoryid" name="category_id" placeholder="Your Category ID...">
      </select>
    </div>
   </div>
  <div class="row">
...
$mysqlinput = "INSERT INTO film_category VALUES ('$film_id','$category_id','$last_update')";
