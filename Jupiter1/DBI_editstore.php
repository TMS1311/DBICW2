...
$data = $conclude-> fetch_array(MYSQLI_BOTH);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$up = "UPDATE store SET store_id='$store_id', address_id='$address_id', manager_staff_id='$manager_staff_id', last_update ='$last_update' WHERE store_id = '$id' ";   // update query
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="number" value="<?php echo $data['manager_staff_id'] ?>" name="manager_staff_id" placeholder="Your Manager Staff ID..." Required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
