...
<div class="container">
<form action="DBI_insert_store.php" method="post">
   <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="number" id="managerstaffid" name="manager_staff_id" placeholder="Your Manager Staff ID...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
...
$manager_staff_id = mysqli_real_escape_string($conn, $_REQUEST['manager_staff_id']);
...
$mysqlinput = "INSERT INTO store VALUES ('$store_id','$manager_staff_id','$address_id','$last_update')";
